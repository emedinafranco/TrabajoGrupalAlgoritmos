...
def mostrar_menu_principal():
    ...
    print(f"║  {COLOR_WHITE}6{COLOR_GREEN} → Busqueda de proveedor                               ║")
    print(f"║  {COLOR_WHITE}7{COLOR_GREEN} → Estadisticas del stock                              ║")
    print(f"║  {COLOR_WHITE}8{COLOR_GREEN} → Listado de precios con iva                          ║")
